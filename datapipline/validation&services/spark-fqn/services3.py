...
df16 = df15\
    .select(concat_ws('.',df6.company,df6.org_unit4,df6.asset,df6.value).alias("fqn"),"message_Type1","id","insert","temperature","pressure","vibration_x","vibration_y","vibration_motor","id","date","time","topic","timestamp","created_by","version","quality","date","time1","DiffInHours")\
    .select(concat_ws(' ',df7.message_Type1).alias("message_Type"),"id","fqn","insert","temperature","pressure","vibration_x","vibration_y","vibration_motor","id","date","time","timestamp","created_by","version","quality","date","time1","DiffInHours")\
    .select(concat_ws(' ',df6.timestamp).alias("createdTime"),"id","message_Type","insert","fqn","temperature","pressure","vibration_x","vibration_y","time","vibration_motor","id","created_by","timestamp","version","quality","date","time1","DiffInHours")\
    .select(concat_ws(' ',df6.temperature,df6.pressure,df6.vibration_x,df6.vibration_y,df6.vibration_motor).alias("v"),"id","createdTime","message_Type","insert","fqn","temperature","pressure","vibration_x","vibration_y","time","timestamp","vibration_motor","id","created_by","version","quality","date","time1","DiffInHours")\
    .select(concat_ws(' ',df15.date,df15.time1).alias("t"),"v","id","createdTime","message_Type","insert","fqn","temperature","pressure","vibration_x","vibration_y","time","timestamp","vibration_motor","id","created_by","version","quality","date","time1","DiffInHours")\
...
df17=df16\
    ...
    .select("header","payload","temperature","pressure","vibration_x","vibration_y","vibration_motor","DiffInHours")

df18 = df17\
    .select("temperature","pressure","vibration_x","vibration_y","vibration_motor","DiffInHours",df17.payload.insert.vqts.id,df17.header.version,df17.header.created_by,df17.header.createdTime,df17.header.message_Type,df17.payload.insert.fqn,df17.payload.insert.vqts.t,df17.payload.insert.vqts.q,df17.payload.insert.vqts.v)
...
df19 = df18\
    ...
    .select("id","version","created_by","createdTime","message_Type","fqn","timestamp","quality","value","temperature","pressure","vibration_x","vibration_y","vibration_motor","DiffInHours")