...
class Base_domain(models.Model):
    ...
    start_datetime = models.DateTimeField(
        db_column='start_datetime', default=timezone.now, blank=True, verbose_name='Datetime')
    end_datetime = models.DateTimeField(
        db_column='end_datetime', default=end_datetime, blank=False, verbose_name='End Datetime')
    name = models.CharField(
        db_column='name', max_length=100, blank=False, unique=True, verbose_name='Name')
    short_name = models.CharField(
        db_column='short_name', max_length=100, blank=False, unique=True, verbose_name='Short Name')
    ...
    accounting_id = models.CharField(
        db_column='accounting_id', max_length=100, blank=True, null=True, verbose_name='Accounting ID')
    serial_id = models.CharField(
        db_column='serial_id', max_length=100, blank=True, null=True, verbose_name='Serial ID')
    registry_id = models.CharField(
        db_column='registry_id', max_length=100, blank=True, null=True, verbose_name='Registry ID')
