...
from .views import ItemScriptSaveView, ItemView,ItemSaveView,ItemDetailsView,ItemDeleteView,ItemTypeDetailsView
...
urlpatterns = [
    ...
    path("deneme/",ItemTypeDetailsView.as_view(),name = "deneme ")
]
