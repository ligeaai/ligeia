# Generated by Django 4.0.5 on 2022-07-29 08:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CODETEXT', models.CharField(max_length=100, null=True)),
                ('PARENT', models.CharField(max_length=100, null=True)),
                ('LEGACYCODE', models.CharField(max_length=50, null=True)),
                ...
                ('LAST_UPDT_USER', models.CharField(default='system', max_length=100)),
                ('LAST_UPDT_DATE', models.DateField(default='2022-07-29', null=True)),
                ('VERSION', models.CharField(default='346e4d8da33f41169e69c0a46032f4a0', max_length=32)),
                ('DB_ID', models.CharField(max_length=32, null=True)),
                ('ROW_ID', models.CharField(default='bc0deb229e914b4a9d9fa0053f6ac87d', max_length=32)),
