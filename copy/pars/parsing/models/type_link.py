...
class type_link (models.Model): 
    ...
    FROM_TYPE = models.CharField(null = False, max_length = 14)
    FROM_TYPE_CLASS = models.CharField(null = False, max_length = 50)
    FROM_CARDINALITY = models.CharField(null = True, max_length = 10)
    TO_TYPE = models.CharField(null = False, max_length = 14)
    TO_TYPE_CLASS = models.CharField(null = False, max_length = 50)
